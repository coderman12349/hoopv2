...
Section:NewButton("Aimbot (Go into Shiftlock)", "Op aimbot", function()
...
PlayerSection:NewSlider("WalkSpeed", "Changes the walkspeed", 19, 0, function(v) 
    game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = v
end)
PlayerSection:NewSlider("Jump Power", "Changes the jump power", 55, 0, function(v) 
